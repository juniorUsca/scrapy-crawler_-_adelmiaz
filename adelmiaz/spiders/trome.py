...
class TromeSpider(Spider):
    name = "trome"
    allowed_domains = ["trome.pe", "googleapis.com"]
    ...
    start_urls = []
    for cont in range(0,500,15):#410
        start_urls.append("http://trome.buscamas.pe/marketing/?start="+str(cont))
    for cont in range(0,1150,15):#1090
        start_urls.append("http://trome.buscamas.pe/publicidad/?start="+str(cont))
    ...
    def parse_date(self, value):
        ### Formato TROME
        #Viernes 18 de octubre del 2013 | 08:00 
    ...
    def get_new(self, response):
        ...
        il.add_value('keywords', sel.xpath('//div[contains(@class,"cont_tags")]//li/a/text()').extract())
        item = il.load_item()
